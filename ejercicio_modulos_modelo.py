...
#from validacion_excepciones import Validacion
...
# ##################### FUNCION CONSULTA GENERAL #########################
    ...
    def funcion_actualizar_usuarios(
        ...
        )  # 9 cambiamos toda la estructura del update
        actualizar.execute()  # indicamos que se ejecute el update
        self.funcion_consulta_general(tree)
        var_nombre.set("")
        var_apellido.set("")
        var_dni.set("")
